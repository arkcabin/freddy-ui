...
/**
 * High-Density "Auth 1" Inspired Sign-In Page
 * Merges the premium Particles background with Ultra-Clean minimalist requirements.
 */
  ...
  return (
    <div className="relative w-full md:h-screen md:overflow-hidden">
      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-12">
        <div className="w-full max-w-[360px] rounded-xl border border-border/50 bg-background/60 p-7 shadow-xl shadow-black/5 backdrop-blur-xl">
          {/* Logo + heading */}
          <div className="mb-8 space-y-3">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] leading-snug text-muted-foreground/50">
                Strategic architecture for modern engineering.
              </p>
            </div>
          </div>
